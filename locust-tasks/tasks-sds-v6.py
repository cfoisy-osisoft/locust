...
import datetime
import socket
from ocs_sample_library_preview import OCSClient, Sds503
...
max_tries = int(os.environ.get("MAX_TRIES_503", 12))
...
def get_data(self):
    ...
    while True:
        ...
        if sema[stream_id].acquire(blocking=False):
            break
        else:
            print(f"@@@@@@@@@@@@@@@@ discard {stream_id} @@@@@@@@@@@@@@@@@@@")
