...
def get_dv(self):
    ...
    result = self.ocs_client.Streams.getRangeValuesInterpolated(
            ...
            locust_name=f"{stream_name}|{stream_id}:{self.dv_month_span}:{offset}")
    """
